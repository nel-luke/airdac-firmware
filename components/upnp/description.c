...
static esp_err_t rootDesc_handler(httpd_req_t *req)
{
    ...
    httpd_resp_send(req, rootDesc_buf, rootDesc_bytes);
...
//    httpd_resp_set_hdr(req, "Connection", "close");
//    httpd_resp_set_hdr(req, "Expires", " : 0");
    ssize_t len = AVTransport_end - AVTransport_start;
    httpd_resp_send(req, AVTransport_start, len);
...
//    httpd_resp_set_hdr(req, "Connection", "close");
//    httpd_resp_set_hdr(req, "Expires", " : 0");
    ssize_t len = ConnectionManager_end - ConnectionManager_start;
    httpd_resp_send(req, ConnectionManager_start, len);
...
//    httpd_resp_set_hdr(req, "Connection", "close");
//    httpd_resp_set_hdr(req, "Expires", " : 0");
    ssize_t len = RenderingControl_end - RenderingControl_start;
    httpd_resp_send(req, RenderingControl_start, len);
